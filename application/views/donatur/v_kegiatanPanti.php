					...
					<div class="row">
						...
						<li><h3><?php echo $kp->pengurus?></h3>
							...
							<div>
								...
								<?php echo anchor('donatur/lihat_komen/'.$kp->kp_id,'<button class="btn btn-danger btn-remove btn-sm"><i class="fa fa-trash mr-2"></i> lihat Komen</button>');?>
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="edit-data<?php echo $kp->kp_id;?>" class="modal fade">
	    <div class="modal-dialog">
	        <div class="modal-content">
	            ...
	            <form class="form-horizontal" action="<?php echo base_url('donatur/ubahkp/')?>" method="post" enctype="multipart/form-data" role="form">
