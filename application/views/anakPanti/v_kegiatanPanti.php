					...
					<div class="row">
						...
						<li><h3><?php echo $kp->pengurus?></h3>
							...
							<div>
								...
								<?php echo anchor('anakPanti/listKomentar/'.$kp->kp_id,'<button class="btn btn-danger btn-remove btn-sm"><i class="fa fa-trash mr-2"></i> lihat Komen</button>');?>
	            ...
	            <form class="form-horizontal" action="<?php echo base_url('anakPanti/komen/')?>" method="post" enctype="multipart/form-data" role="form">
		            <div class="modal-body">
		                    ...
		                    <div class="form-group">
		                        ...
		                        <div class="col-lg-10">
		                            <input type="hidden" class="form-control" id="tanggalap" name="tanggalap">
		                        </div>
		                    </div>
		                    <div class="form-group">
		                        <label class="col-lg-2 col-sm-2 control-label">Komentar</label>
		                        <div class="col-lg-10">
		                        	<input type="text" class="form-control" id="komenap" name="komenap"></input>
		                        </div>
		                    </div>
